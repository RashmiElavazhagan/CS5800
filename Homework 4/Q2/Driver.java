...
public class Driver {
    public static void main(String[] args) {
        ...
        Customer customer2 = new Customer("Alice", "Paleo");
        Customer customer3 = new Customer("Michael", "Vegan");
        Customer customer4 = new Customer("Emily", "Nut Allergy");
        Customer customer5 = new Customer("David", "Vegan");
        Customer customer6 = new Customer("Sophia", "Paleo");
